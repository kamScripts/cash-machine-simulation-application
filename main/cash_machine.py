...
''' 
    ...
    def _withdraw(self, account):
        ...
        if re.match(r'^\d+$', amount):
            ...
            if(boolean):
                print(f' {green_no_background("You successfully withdrew £")}{amount} '.center(self.MAX_LENGTH, '*'))   
            else:
                print(red_no_background('You have not enough funds').center(self.MAX_LENGTH, '*'))
        else:
    ...
    def _set_new_pin(self, account):        
        ...
        if re.match(r'^\d{4}$', new_pin):                        
              ...
              print(green_no_background(' success, new pin set. ').center(self.MAX_LENGTH, '*'))
                ...
                print(red_no_background(' incorrect format. type(4 digits) ').center(self.MAX_LENGTH, '*'))
    def _goodbye(self):
